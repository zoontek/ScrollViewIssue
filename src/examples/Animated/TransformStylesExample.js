...
function AnimatedView({properties, useNativeDriver}) {
...
function notSupportedByNativeDriver(property) {
  return property === 'skewX' || property === 'skewY';
}

function AnimatedTransformStyleExample() {
