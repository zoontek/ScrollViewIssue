...
import {} from './RNTesterTheme';

const HeaderIOS = ({onBack, title, documentationURL, theme}) => {
  return (
    <SafeAreaView>
...
const HeaderAndroid = ({title, documentationURL, theme}) => {
  return (
    <SafeAreaView>
...
export default function RNTTitleBar({onBack, title, documentationURL, theme}) {
